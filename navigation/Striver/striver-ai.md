...
author: Hithin, Neil, Kush, Nikith, Rayhaan, Zaid, Pradyun
---
...
<script>
    ...
    if (checkbox.checked) {
        window.location.href = '{{site.baseurl}}/Striver/striver-ai';
    }
    }
